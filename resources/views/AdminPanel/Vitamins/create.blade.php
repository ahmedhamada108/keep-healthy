@extends('layouts.app')
    ...
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">Create new vitamin</h6>
        @if ($errors->any())
        ...
        <nav class="page-breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Create new vitamin
            </li>
					</ol>
				</nav>
        <form method="POST" action="{{route('vitamins.store')}}" enctype="multipart/form-data" class="forms-sample">
          @csrf

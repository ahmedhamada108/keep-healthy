@extends('layouts.app')
    ...
    <div class="card">
      <div class="card-body">
        <h6 class="card-title">Create new exercises</h6>
        @if ($errors->any())
        ...
        <nav class="page-breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">Create new Exercises
            </li>
					</ol>
				</nav>
        <form method="POST" action="{{route('exercises.store')}}" enctype="multipart/form-data" class="forms-sample">
          @csrf
          ...
          <div class="form-group">
            ...
            <input type="text"value="{{ old('video_url') }}" name="video_url" class="form-control" id="exampleInputUsername1" placeholder="title">
          </div>
          <div class="form-group">
